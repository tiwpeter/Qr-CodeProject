...
import 'package:poject_qr/old/widgets/HomeAppBar.dart'; // ตรวจสอบให้แน่ใจว่าเส้นทางของ HomeAppBar ถูกต้อง
    ...
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment
            .start, // เปลี่ยนเป็น start เพื่อจัดเรียงที่จุดเริ่มต้น
        children: [
          // รูปภาพ
          Container(
          ...
          Container(
            padding: EdgeInsets.only(
                right: 40.0), // เพิ่มระยะห่างทางด้านขวาของข้อความ
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              crossAxisAlignment: CrossAxisAlignment
                  .start, // เพื่อจัดข้อความให้เริ่มที่ด้านซ้าย
              children: [
                Text(textA,
