...
import 'package:poject_qr/pages/homepage/todo.dart'; // stock
import 'package:poject_qr/pages/homepage/LogInput.dart'; // Log
import 'package:poject_qr/pages/homepage/LineChart/LineChartPage%20.dart'; //analysic

//import 'package:poject_qr/pages/sales_screen.dart'; ข้อมูลการขายlog
//import 'package:poject_qr/pages/BarCodeSale.dart';
//import 'package:poject_qr/pages/qrcode.dart';

// ตรวจสอบว่ามีการสร้าง Homemain widget และ path ถูกต้อง
import 'package:poject_qr/pages/homepage/startScan/Test.dart'; // ตรวจสอบว่ามีการสร้าง Homemain widget และ path ถูกต้อง
