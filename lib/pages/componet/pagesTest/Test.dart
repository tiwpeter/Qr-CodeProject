...
class _CarouselExampleState extends State<CarouselExample> {
  ...
  // เพิ่มรายการข้อความที่ต้องการแสดงใต้แต่ละภาพ
  final List<String> captions = [
    'Add Product', // ข้อความใต้ภาพแรก
    'Search', // ข้อความใต้ภาพที่สอง
    'Sell', // ข้อความใต้ภาพที่สาม
  ];
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        captions[index], // ใช้ข้อความจาก list captions
                        style: TextStyle(
                          fontSize: 18,
