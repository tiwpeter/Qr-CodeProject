            ...
            itemBuilder: (context, index, realIndex) {
              return Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    // Image with circular frame, padding, and background color
                    Expanded(
                      flex: 3,
                      child: Center(
                        ...
                        child: Container(
                          padding: EdgeInsets.all(
                              8.0), // Padding between the image and the border
                          decoration: BoxDecoration(
                            color: Colors
                                .blue, // Background color of the circular border
                            shape: BoxShape
                          ...
                          child: ClipOval(
                            child: Image.network(
                              imageUrls[index],
                              fit: BoxFit.cover,
                              width: 150.0, // Image width
                              height: 150.0, // Image height
                            ),
                          ),
                        ),
                      ),
