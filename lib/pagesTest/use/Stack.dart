              ...
              Stack(
                children: [
                  AnimatedOpacity(
                    ...
                    duration: Duration(seconds: 2), // ระยะเวลาอนิเมชัน
                          ...
                          children: [
                            ...
                            Stack(
                              children: [
                                Align(
                                  alignment:
                                      Alignment.topLeft, // จัดข้อความให้ชิดซ้าย
                                  child: Column(
                                    ...
                                    children: [
                                      AnimatedDefaultTextStyle(
                                        style: TextStyle(
                                          fontSize:
                                              _fontSizeTitle, // ขยายขนาดข้อความหัวข้อ
                                          fontWeight: FontWeight.bold,
                                        ),
                                        duration: Duration(seconds: 2),
                                        child: Text('ข้อความแรกที่ต้องการแสดง'),
                                      ),
                                      SizedBox(
                                          height: 5), // ช่องว่างระหว่างข้อความ
                                      AnimatedDefaultTextStyle(
                                        style: TextStyle(
                                          fontSize:
                                              _fontSizeSubtitle, // ขยายขนาดข้อความรอง
                                          color: Colors.grey,
                                        ),
                                        duration: Duration(seconds: 2),
                                        child:
                                            Text('ข้อความที่สองที่ต้องการแสดง'),
                                      ),
                                    ],
                                  ),
                                ),
